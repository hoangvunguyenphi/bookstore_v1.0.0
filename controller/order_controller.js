...
exports.updateCartItem = function (cartItem) {
  listCartCheckout = cartItem;
  console.log(listCartCheckout);
}

exports.check_out = function (req, res) {
  console.log(listCartCheckout);
  res.render("../views/site/page/checkout.ejs", {
    dcc: listCartCheckout,
    products: [],
    totalPrice: 0,
    totalQty: 0
  });
...
exports.add_order = function (req, res, next) {
  ...
  var params = {
    ...
    Item: {
      ...
      tienship: 1111,
      items: listCartCheckout,
      tongtienthanhtoan: 123, //tổng tiền thanh toán xử lý
